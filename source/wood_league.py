...
class Robot:
    ...
    def which_cost_not_fulfill(self, sample)->str:
        if sample.cost[0] > self.storages["A"]: return "A"
        elif sample.cost[1] > self.storages["B"]: return "B"
        elif sample.cost[2] > self.storages["C"]: return "C"
        elif sample.cost[3] > self.storages["D"]: return "D"
        elif sample.cost[4] > self.storages["E"]: return "E"
        else: return ""


    def is_sample_fulfill(self, sample):

        if sample.cost[0] > self.storages["A"]: return False
        elif sample.cost[1] > self.storages["B"]: return False
        elif sample.cost[2] > self.storages["C"]: return False
        elif sample.cost[3] > self.storages["D"]: return False
        elif sample.cost[4] > self.storages["E"]: return False
